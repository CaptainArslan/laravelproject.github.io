			...
			<table class="table table-striped table-hover ">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{$db_users->id}}" class="edit_user" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
 							<a href="{{$db_users->id}}" class="delete" data-toggle="modal"  ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>				
					@endforeach
				</tbody>
		...
		<div class="modal-content">
			<form>
				...
				<div class="modal-footer">
					...
					<a href="{{$db_users->id}}" data-teacherid='{{$db_users->id}}' class="btn btn-danger">Delete</a>
				</div>
			</form>
		</div>
	</div>
